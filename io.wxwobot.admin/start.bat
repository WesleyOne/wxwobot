...
set "JAVA_OPTS=-XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xms256m -Xmx256m -XX:MetaspaceSize=32m -XX:MaxMetaspaceSize=64m -XX:+UseConcMarkSweepGC -Xmn128m -Xss328k"
