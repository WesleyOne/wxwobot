...
set MAIN_CLASS=io.wxwobot.admin.web.common.MyConfig
...
set "JAVA_OPTS=-XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:./logs/gc.$$.log -Xms500m -Xmx500m  -XX:MetaspaceSize=64m -XX:MaxMetaspaceSize=128m -XX:+UseConcMarkSweepGC -Xmn400m -Xss328k"
