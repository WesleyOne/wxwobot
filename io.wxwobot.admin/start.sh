...
MAIN_CLASS=io.wxwobot.admin.web.common.MyConfig

# Java 命令行参数，根据需要开启下面的配置，改成自己需要的，注意等号前后不能有空格
# JAVA_OPTS="-Xms256m -Xmx1024m -Dundertow.port=80 -Dundertow.host=0.0.0.0"
# JAVA_OPTS="-Dundertow.port=80 -Dundertow.host=0.0.0.0"
JAVA_OPTS="-XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:/home/www/output/logs/wxrobot/gc.$$.log -Djava.security.egd=file:/dev/./urandom -Xms256m -Xmx256m  -XX:MetaspaceSize=64m -XX:MaxMetaspaceSize=64m -XX:+UseConcMarkSweepGC -Xmn128m -Xss328k"
